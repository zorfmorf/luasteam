...
-- Interfaces are populated on Steam.Init()/Steam.GameServerInit()
assert(Steam.Matchmaking == nil, "matchmaking should be nil before Steam.Init")
assert(Steam.GameServerStats == nil, "gameServerStats should be nil before Steam.GameServerInit")
assert(Steam.Screenshots == nil, "screenshots should be nil before Steam.Init")
